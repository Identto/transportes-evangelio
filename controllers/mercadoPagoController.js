...
mercadopago.configure({
    sandbox: true,
    access_token: 'TEST-213454760139181-020610-7c82de1efba8055d2ebbf54a1c9f141a-378377770'
});
        ...
        if (data.body !== null && data.body !== undefined) {
            ...
            Order.create(order, async (err, id) => {
                ...
                for (const product of order.products) {
                    await OrderHasProducts.create(id, product.id, product.quantity, product.exitDate, (err, id_data) => {
                        if (err) {
                            return res.status(501).json({
                                success: false,
