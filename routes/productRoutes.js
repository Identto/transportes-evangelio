...
module.exports = (app, upload) => {
    ...
    app.post('/api/products/update',  passport.authenticate('jwt', { session: false }), upload.array('image', 3), productsController.update);
    app.post('/api/products/delete',  passport.authenticate('jwt', { session: false }),upload.array('image', 3), productsController.delete);
